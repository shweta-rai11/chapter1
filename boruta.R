...
trainSet <- as.data.frame(fread("/Users/swetarai/GSE_merging_data/train_19_march.csv"))
...
write.table(confirmed_features, 
            file = "/Users/swetarai/GSE_merging_data/boruta_selected_genes_trial.txt", 
            quote = FALSE, 
            row.names = FALSE, 
            col.names = FALSE)
